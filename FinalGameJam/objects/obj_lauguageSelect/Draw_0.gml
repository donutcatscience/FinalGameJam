...
if (global.language = "english"){
	draw_text(centerWidth,centerHeight,"language Select");
} else if (global.language = "spanish"){
	draw_text(centerWidth,centerHeight,"Selección de Idioma");
} else if (global.language = "french"){
	draw_text(centerWidth,centerHeight,"Sélection de la Langue");
}